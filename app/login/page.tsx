    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full mt-1 border-gray-300 rounded-md shadow-lg focus:ring-4 focus:ring-blue-300 focus:border-blue-500 sm:text-sm"
          value={data.email}
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full mt-1 border-gray-300 rounded-md shadow-lg focus:ring-4 focus:ring-blue-300 focus:border-blue-500 sm:text-sm pr-12"
            value={data.password}
      ...
      <div className="flex flex-col gap-4 mt-4">
        <button
          className="flex items-center justify-center gap-2 py-2 px-4 text-sm bg-gray-200 rounded-lg shadow-md hover:bg-gray-300 transition"
          onClick={(e) => {
            e.preventDefault();
            signIn("google");
          }}
